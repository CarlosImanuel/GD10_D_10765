...
import com.example.gd10_d_10765.databinding.ActivityFormEditMahasiswaBinding
import okhttp3.Call
...
class FormEditMahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnUpdate.setOnClickListener {
            with(binding) {
                ...
                RClient.instances.updateData(nim,nama,alamat,prodi,tgllahir).enqueue(
    ...
    {
        val calender = android.icu.util.Calendar.getInstance()

        return DatePickerDialog(
            context, datePicker,
            calender[android.icu.util.Calendar.YEAR],
            calender[android.icu.util.Calendar.MONTH],
            calender[android.icu.util.Calendar.DAY_OF_MONTH],
        )
    }
}
